...
(function(){
    ...
    UM.registerWidget( widgetName,{
        ...
        initContent:function( editor, $widget ){
            ...
            me.lang = lang;
            me.editor = editor;
            me.root().html( jQuery.parseTmpl( me.tpl, jQuery.extend( { video_url: video_url }, lang['static'] ) ) );
        ...
        initController: function( lang ){
            ...
            if(img && img.className == "edui-faked-video"){
                jQuery("#eduiVideoUrl")[0].value = url = img.getAttribute("_url");
                jQuery("#eduiVideoWidth")[0].value = img.width;
                jQuery("#eduiVideoHeight")[0].value = img.height;
        ...
        createPreviewVideo: function(url){
            ...
            if(!youkuPlay){
                if (matches){
                    ...
                    jQuery("#eduiVideoPreview").html( lang.urlError );
                    return;
                }
            }else{
                url = url.replace(/\?f=.*/,"");
            }
            jQuery("#eduiVideoPreview")[0].innerHTML = '<embed type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"' +
                ' src="' + url + '"' +
                ' width="' + 420  + '"' +
                ' height="' + 280  + '"' +
        ...
        insertSingle: function(){
            ...
            var me = this,
                width = jQuery("#eduiVideoWidth")[0],
                height = jQuery("#eduiVideoHeight")[0],
                url=jQuery('#eduiVideoUrl')[0].value,
        ...
        updateAlignButton: function( align ) {
            var aligns = jQuery( "#eduiVideoFloat" )[0].children;
        ...
        createAlignButton: function( ids ) {
            ...
            for ( var i = 0, ci; ci = ids[i++]; ) {
                var floatContainer = jQuery( "#" + ci ) [0],
        ...
        switchSelect: function( selectParentId ) {
            var selects = jQuery( "#" + selectParentId )[0].children;
