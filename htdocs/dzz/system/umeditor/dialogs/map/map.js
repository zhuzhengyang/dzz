(function () {
    ...
    UM.registerWidget(widgetName, {
        ...
        initContent: function (editor, $widget) {
            ...
            me.root().html(jQuery.parseTmpl(me.tpl, jQuery.extend({}, lang['static'], {
                'theme_url': theme_url
            })));
        ...
        initRequestApi: function () {
            ...
            if (window.BMap && window.BMap.Map) {
                ...
                $ifr = jQuery('<iframe style="display: none;"></iframe>');
        ...
        requestMapApi: function (src) {
            ...
            if (src.length) {
                ...
                if (_src) {
                    jQuery.getScript(_src, function () {
        ...
        initBaiduMap: function () {
            ...
            var map = new BMap.Map(jQuery("#eduiMapContainer")[0]),
                me = this,
                marker,
                point,
                imgcss,
                img = jQuery(me.editor.selection.getRange().getClosedNode());
        ...
        doSearch: function () {
            var me = this,
                city = jQuery('#eduiMapCity').val(),
                address = jQuery('#eduiMapAddress').val();
        ...
        initEvent: function () {
            ...
            jQuery('#eduiMapAddress').on('keydown', function (evt) {
                evt = evt || event;
                if (evt.keyCode == 13) {
                    me.doSearch();
                    return false;
            ...
            jQuery("#eduiMapSearchBtn").on('click', function (evt) {
                me.doSearch();
            });

            jQuery("#eduiMapAddress").focus();
