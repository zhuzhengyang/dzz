<?php if(!defined('IN_DZZ')) exit('Access Denied'); include template('common/header_simple_start'); ?><link href="dzz/system/images/themes/default/style.min.css?<?php echo VERHASH;?>" rel="stylesheet" media="all">
<style>
html,body{
height:100%;
width:100%;
...
</style><?php include template('common/header_simple_end'); ?><div id="orgtree" class="orgtree-container" style="padding:5px;overflow:auto;"></div>
