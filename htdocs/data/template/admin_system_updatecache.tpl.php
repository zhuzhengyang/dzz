  ...
  <div class="bs-main-container  clearfix" >
    ...
    <div class="main-content" style="padding:20px;border-top:1px solid #FFF">
      <div class="well well-sm"> 
        <?php if($step==1) { ?>
        <form method="post" class="form-horizontal form-horizontal-left" action="<?php echo BASESCRIPT;?>?mod=<?php echo $mod;?>&op=updatecache&step=2">
        ...
        <p class="text-success ml20"><a href="<?php echo BASESCRIPT;?>?mod=system&op=updatecache&step=3&type=data_tpl" class="lightlink">如果您的浏览器没有自动跳转，请点击这里</a></p>
        <script type="text/JavaScript">setTimeout(function(){location.href='<?php echo BASESCRIPT;?>?mod=system&op=updatecache&step=3&type=data_tpl';}, 2000);</script> 
        <?php } elseif($step==3) { ?>
        <p class="text-success ml20" style="margin:10px;">全部缓存更新完毕</p>
        <script type="text/javascript">window.setTimeout(function(){location.href='<?php echo BASESCRIPT;?>?mod=system&op=updatecache';},5000);</script> 
        <?php } ?> 
      </div>
        <ul class="help-block">
          <h5>提示信息</h5>
